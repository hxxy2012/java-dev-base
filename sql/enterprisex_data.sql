...
(1, '欢迎使用EnterpriseX框架', '欢迎使用EnterpriseX企业级开发框架！这是一个功能完善的企业级应用开发平台。', 1, 1, 1, 0, NULL, NULL, '系统', NOW()),
(2, '系统功能介绍', '系统提供了完善的权限管理、用户管理、角色管理、菜单管理等基础功能，以及丰富的监控和工具模块。', 2, 2, 1, 0, NULL, NULL, '系统', NOW()),
(3, '请及时修改密码', '为了账号安全，建议您首次登录后及时修改默认密码。可以在个人中心-修改密码中进行操作。', 1, 3, 1, 0, NULL, NULL, '系统', NOW());
